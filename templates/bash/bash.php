...
// begin editing after this line ?>
        ...
        <head>
            ...
            <style type="text/css" media="all">
                ...
                @import "./templates/bash/4p.css";
            </style>
        </head>
        <body>
        <div id="site_all">
            <div id="site_nav">
                <div id="site_nav_4p_upper_wrapper">
                ...
                print '</div><!-- #site_nav_upper --></div><!-- 4p wrapper --><div id="site_nav_4p_lower_wrapper">';
                print $this->get_menu();
                print '</div><!-- 4p wrapper --></div><!-- #site_nav -->';
